...
data_path = '/workspace/data/mnist'
...
torch.save(net.state_dict(), "quant_model.pth")
...
print("Total correctly classified test set images: {}/{}".format(correct, total))
