...
# dead neuron problem -> surrogate gradient approach
...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        # add ".to(device)" to avoid finding two devices
...
# taking the softmax of the output layer as well as generating a loss at the output.
...
for epoch in range(num_epochs):
    ...
    for data, targets in train_batch:
        ...
        with torch.no_grad():
            ...
            if counter % 50 == 0:
                # complete train_printer found in Colab
                train_printer(
                    data, targets, epoch,
                    counter, iter_counter,
...
# Total correctly classified test set images: 9374/10000
# Test Set Accuracy: 93.74%
